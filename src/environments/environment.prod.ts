...
let Url_WSCompensations = domain_compensaciones + '/WSCompensaciones-web/webresources/WSCompensaciones/';
let Url_WSBilling = domain_compensaciones + '/WSCompensaciones-web/webresources/WSBilling/';
...
export const environment = {
  ...
  urlApi_failureValidation: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSValidacionFallasRR/',
  urlApi_billingRR: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSFacturacionRR/',
  urlApi_rentsRR: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSRentasRR/',
  urlApi_users: domain_usuarios + '/WsPortalUsuariosRest-web/ws/WsPortalUsuariosRest/',
  urlApi_rules: domain_compensaciones + '/WSCompensaciones-web/webresources/WSNodesRules/',
  urlApi_Businessrules: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSBusinessRulesRR/',
  urlApi_BillingFiles: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSBilligRR/',
  urlApi_ConsolidationAccNod: domain_compensaciones + '/WSCompensacionesBatchRR-web/webresources/WSConsolidationRR/',
  urlApi_notifications: domain_notifications + '/Notification/V2.0/Rest/',
  endpoints: {
    // Settings
